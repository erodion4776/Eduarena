    ...
    <nav className={`sticky top-0 z-50 border-b transition-colors duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className={`text-xl font-display font-black tracking-[0.15em] uppercase ${mode === 'arena' ? 'text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]' : 'text-slate-900'} transition-colors duration-500`}>
            Edu <span className={mode === 'arena' ? 'text-cyan-400' : 'text-blue-600'}>Arena</span>
          </span>
        </div>
